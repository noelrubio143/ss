...
PANEL_PORT=44380
PANEL_REPO_BASE="https://raw.githubusercontent.com/noelrubio143/ss/refs/heads/main/panel"
...
install_udp_custom() {
    ...
    local binary_url=""
    if [[ "$arch" == "x86_64" ]]; then
        binary_url="https://raw.githubusercontent.com/noelrubio143/ss/refs/heads/main/udp/udp-custom-linux-amd64"
        echo -e "${C_BLUE}ℹ️ Detected x86_64 (amd64) architecture.${C_RESET}"
    elif [[ "$arch" == "aarch64" || "$arch" == "arm64" ]]; then
        binary_url="https://raw.githubusercontent.com/noelrubio143/ss/refs/heads/main/udp/udp-custom-linux-arm"
...
install_falcon_proxy() {
    ...
    local releases_json=$(curl -s "https://api.github.com/repos/noelrubio143/ss/refs/heads/releases")
    ...
    local download_url="https://github.com/noelrubio143/ss/refs/heads/releases/download/$SELECTED_VERSION/$binary_name"
